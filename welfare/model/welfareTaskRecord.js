...
/**
 * @apiDefine welfareTaskRecordRequestEntity 用户完成任务记录请求实体
...
/**
 * @apiDefine welfareTaskRecordResponseEntity 用户完成任务记录响应实体
...
module.exports = app => {
  ...
  const Table = app.model.define('welfareTaskRecord', {
    id: {
      type: INTEGER,
      primaryKey: true,
      autoIncrement: true,
