...
const mapState = ({ welfareUserCoinRecordList, loading }) => ({
  list: welfareUserCoinRecordList.list,
  pagination: welfareUserCoinRecordList.pagination,
  loading: loading.models.welfareUserCoinRecordList,
})

const mapDispatch = (dispatch) => ({
  loadList: (payload) => dispatch({
    type: 'welfareUserCoinRecordList/fetch',
    payload
  }),
})
