...
const mapState = ({ welfareUserOpenPacketRecordList, loading }) => ({
  list: welfareUserOpenPacketRecordList.list,
  pagination: welfareUserOpenPacketRecordList.pagination,
  loading: loading.models.welfareUserOpenPacketRecordList,
})

const mapDispatch = (dispatch) => ({
  loadList: (payload) => dispatch({
    type: 'welfareUserOpenPacketRecordList/fetch',
    payload
  }),
})
