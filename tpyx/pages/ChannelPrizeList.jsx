...
const mapState = ({ channelPrizeList, loading }) => ({
  list: channelPrizeList.list,
  pagination: channelPrizeList.pagination,
  loading: loading.models.channelPrizeList,
})

const mapDispatch = (dispatch) => ({
  loadList: (payload) => dispatch({
    type: 'channelPrizeList/fetch',
    payload
  }),
  deleteItem: (id) => dispatch({
    type: 'channelPrizeList/deleteItem',
    payload: {id}
  }),
  createItem: (data) => dispatch({
    type: 'channelPrizeList/createItem',
    payload: {data}
  }),
  modifyItem: (id, data) => dispatch({
    type: 'channelPrizeList/modifyItem',
    payload: {id, data}
  })
})
