...
const mapState = ({ welfareCoinRecordList, loading }) => ({
  list: welfareCoinRecordList.list,
  pagination: welfareCoinRecordList.pagination,
  loading: loading.models.welfareCoinRecordList,
})

const mapDispatch = (dispatch) => ({
  loadList: (payload) => dispatch({
    type: 'welfareCoinRecordList/fetch',
    payload
  }),
})
