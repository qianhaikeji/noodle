...
/**
 * @apiDefine welfareUserTaskRecordRequestEntity 用户完成任务记录请求实体
...
/**
 * @apiDefine welfareUserTaskRecordResponseEntity 用户完成任务记录响应实体
...
module.exports = app => {
  ...
  const Table = app.model.define('welfareUserTaskRecord', {
    id: {
      type: INTEGER,
      primaryKey: true,
      autoIncrement: true,
    ...
    tableName: 'welfare_user_task_record'
  })
