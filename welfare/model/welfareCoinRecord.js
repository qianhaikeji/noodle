...
/**
 * @apiDefine welfareCoinRecordRequestEntity 用户福币记录请求实体
...
/**
 * @apiDefine welfareCoinRecordResponseEntity 用户福币记录响应实体
...
module.exports = app => {
  ...
  const Table = app.model.define('welfareCoinRecord', {
    id: {
      type: INTEGER,
      primaryKey: true,
      autoIncrement: true,
