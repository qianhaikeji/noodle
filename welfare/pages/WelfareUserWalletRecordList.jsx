...
const mapState = ({ welfareUserWalletRecordList, loading }) => ({
  list: welfareUserWalletRecordList.list,
  pagination: welfareUserWalletRecordList.pagination,
  loading: loading.models.welfareUserWalletRecordList,
})

const mapDispatch = (dispatch) => ({
  loadList: (payload) => dispatch({
    type: 'welfareUserWalletRecordList/fetch',
    payload
  }),
})
