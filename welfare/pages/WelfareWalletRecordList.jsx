...
const mapState = ({ welfareWalletRecordList, loading }) => ({
  list: welfareWalletRecordList.list,
  pagination: welfareWalletRecordList.pagination,
  loading: loading.models.welfareWalletRecordList,
})

const mapDispatch = (dispatch) => ({
  loadList: (payload) => dispatch({
    type: 'welfareWalletRecordList/fetch',
    payload
  }),
})
