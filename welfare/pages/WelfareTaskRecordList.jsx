...
const mapState = ({ welfareTaskRecordList, loading }) => ({
  list: welfareTaskRecordList.list,
  pagination: welfareTaskRecordList.pagination,
  loading: loading.models.welfareTaskRecordList,
})

const mapDispatch = (dispatch) => ({
  loadList: (payload) => dispatch({
    type: 'welfareTaskRecordList/fetch',
    payload
  }),
})
