...
/**
 * @apiDefine welfareUserWalletRecordRequestEntity 用户钱包记录请求实体
...
/**
 * @apiDefine welfareUserWalletRecordResponseEntity 用户钱包记录响应实体
...
module.exports = app => {
  ...
  const Table = app.model.define('welfareUserWalletRecord', {
    id: {
      type: INTEGER,
      primaryKey: true,
      autoIncrement: true,
    ...
    tableName: 'welfare_user_wallet_record'
  })
