...
/**
 * @apiDefine welfareOpenPacketRecordRequestEntity 用户开红包记录请求实体
...
/**
 * @apiDefine welfareOpenPacketRecordResponseEntity 用户开红包记录响应实体
...
module.exports = app => {
  ...
  const Table = app.model.define('welfareOpenPacketRecord', {
    id: {
      type: INTEGER,
      primaryKey: true,
      autoIncrement: true,
    ...
    tableName: 'welfare_open_packet_record'
  })
